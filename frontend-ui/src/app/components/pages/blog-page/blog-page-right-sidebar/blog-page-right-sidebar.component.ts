...
@Component({
  selector: 'app-blog-page-right-sidebar',
  templateUrl: './blog-page-right-sidebar.component.html',
  styleUrls: ['./blog-page-right-sidebar.component.scss'],
})
export class BlogPageRightSidebarComponent {
