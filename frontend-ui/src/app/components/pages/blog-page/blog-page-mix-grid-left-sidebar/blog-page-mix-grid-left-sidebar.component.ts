...
@Component({
  selector: 'app-blog-page-mix-grid-left-sidebar',
  templateUrl: './blog-page-mix-grid-left-sidebar.component.html',
  styleUrls: ['./blog-page-mix-grid-left-sidebar.component.scss'],
})
export class BlogPageMixGridLeftSidebarComponent {
