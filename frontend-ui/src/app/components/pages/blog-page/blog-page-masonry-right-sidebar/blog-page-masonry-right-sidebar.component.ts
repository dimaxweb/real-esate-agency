...
@Component({
  selector: 'app-blog-page-masonry-right-sidebar',
  templateUrl: './blog-page-masonry-right-sidebar.component.html',
  styleUrls: ['./blog-page-masonry-right-sidebar.component.scss'],
})
export class BlogPageMasonryRightSidebarComponent {
