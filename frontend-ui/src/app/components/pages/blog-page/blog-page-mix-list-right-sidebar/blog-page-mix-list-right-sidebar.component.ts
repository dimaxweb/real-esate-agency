...
@Component({
  selector: 'app-blog-page-mix-list-right-sidebar',
  templateUrl: './blog-page-mix-list-right-sidebar.component.html',
  styleUrls: ['./blog-page-mix-list-right-sidebar.component.scss'],
})
export class BlogPageMixListRightSidebarComponent {
