...
@Component({
  ...
  templateUrl: './blog-page-creative-left-sidebar.component.html',
  styleUrls: ['./blog-page-creative-left-sidebar.component.scss'],
})
export class BlogPageCreativeLeftSidebarComponent {
