...
@Component({
  selector: 'app-blog-page-list-no-sidebar',
  templateUrl: './blog-page-list-no-sidebar.component.html',
  styleUrls: ['./blog-page-list-no-sidebar.component.scss'],
})
export class BlogPageListNoSidebarComponent {
