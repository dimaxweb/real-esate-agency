...
@Component({
  selector: 'app-blog-page-mix-list-left-sidebar',
  templateUrl: './blog-page-mix-list-left-sidebar.component.html',
  styleUrls: ['./blog-page-mix-list-left-sidebar.component.scss'],
})
export class BlogPageMixListLeftSidebarComponent {
