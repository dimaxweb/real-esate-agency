...
@Component({
  selector: 'app-blog-page-list-left-sidebar',
  templateUrl: './blog-page-list-left-sidebar.component.html',
  styleUrls: ['./blog-page-list-left-sidebar.component.scss'],
})
export class BlogPageListLeftSidebarComponent {
