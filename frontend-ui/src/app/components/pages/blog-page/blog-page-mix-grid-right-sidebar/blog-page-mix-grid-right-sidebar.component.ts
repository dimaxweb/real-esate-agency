...
@Component({
  selector: 'app-blog-page-mix-grid-right-sidebar',
  templateUrl: './blog-page-mix-grid-right-sidebar.component.html',
  styleUrls: ['./blog-page-mix-grid-right-sidebar.component.scss'],
})
export class BlogPageMixGridRightSidebarComponent {
